...
requests, discussions on this repository) and when an individual is
officially representing the project in public spaces.

## Enforcement

mcphound is solo-maintained (see [GOVERNANCE.md](GOVERNANCE.md)). Instances
of abusive, harassing, or otherwise unacceptable behavior may be reported to
the maintainer at **mark.doyle4312@gmail.com**. All complaints will be
